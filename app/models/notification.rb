class Notification < ApplicationRecord
  ...
  EVENT_TYPES = %w[application_submitted meeting_scheduled payment_plan_selected payment_completed form_signed family_first_login family_restored_from_deletion staff_document_signed email_delivery_failed].freeze
